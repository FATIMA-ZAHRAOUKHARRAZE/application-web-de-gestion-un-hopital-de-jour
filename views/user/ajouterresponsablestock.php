...
if( !empty($_POST))
    {
        if(isset($_POST['ajouterresponsablestock']))
        {
                $id=$_POST['txtid'];
                $nom=$_POST['txtnom'];
        ...
        $m->insertuser($values);
        $m=new UserModel();
        $m->InsertResponsableStock($value);
...
<head>
    ...
    <title>Ajouter Responssable Stock</title>
    <style type="text/css">
        .btn{
        ...
        <div class="container"  style="margin-bottom:70px;">  
            <div class="col-sm-12" >
                <form method="post" name="FRMDIPLOME"  style="margin-top:20px; margin-left:100px;">
                    <div class="row g-3">
                        <div  class="col-5">
                            <label for="txtid" id="LBLid"  name="LBLid">Num Responsable De Stock</label>
                            <input type="text" id="txtid" name="txtid"placeholder="saisir votre id" class="form-control">
     
                            <label for="txtnom" id="LBLNOM"  name="LBLNOM">Nom Responsable De Stock</label>
                            <input type="text" id="txtnom" name="txtnom" placeholder="saisir votre nom" class="form-control">
      
                            <label for="TXTprenom" id="LBLprenom"  name="LBLprenom" > Prenom Responsable De Stock</label>
                            <input type="text" id="TXTprenom" name="TXTprenom" placeholder="saisir prenom" class="form-control" >
                            <label for="tele">  Telephone De Responsable De Stock</label>
                        ...
                        <div class="col-5">
                            ...
                            <label for="email" id="email" name="email"> Email De Responsable De Stock</label>
                            ...
                            <input type="text" class="form-control" name="txtrole" placeholder="saisir le role" value="rstock"  readonly>
                        </div>
                        <div class="col-1"></div>    
                    </div> 
                    <br>
                    <button type="submit" id="bntajouter" name="ajouterresponsablestock" class="btn"> <i class="material-icons">add</i></button> 
                </form>
            </div> 
        </div> 
    </div> 
