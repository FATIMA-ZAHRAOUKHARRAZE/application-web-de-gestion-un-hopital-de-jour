...
if( !empty($_POST))
    {
        if(isset($_POST['ajoutermedecinchef']))
        {
                $id=$_POST['txtid'];
                $nom=$_POST['txtnom'];
...
<head>
    ...
    <title>Ajouter Medecin Chef</title>
    <style type="text/css">
        .btn{
                ...
                <form method="post" name="FRMDIPLOME"  style="margin-top:20px; margin-left:100px;">
                    <div class="row g-3">
                        ...
                        <div class="col-5">
                            ...
                            <label for="email" id="email" name="email"> Email De Medecin Chef</label>
                            ...
                            <input type="text" class="form-control" name="txtrole" placeholder="saisir le role" value="Medecinchef"  readonly>
                        </div>
                        <div class="col-1"></div>    
                    </div> 
                    <br>
                    <button type="submit" id="bntajouter" name="ajoutermedecinchef" class="btn"> <i class="material-icons">add</i></button> 
                </form>
            </div> 
        </div> 
    </div> 
