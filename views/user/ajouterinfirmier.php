...
if( !empty($_POST))
    {
        if(isset($_POST['ajouterinfirmier']))
        {
                $id=$_POST['txtid'];
                $nom=$_POST['txtnom'];
...
<div class="card text-dark bg-light mb-3" style="max-width: 95%; height:400px; margin-left:100px; margin-right:100px; margin-top:70px;">
    <div class="card-body">
        <div class="container"  style="margin-bottom:70px;">  
            <div class="col-sm-12" >
            <form method="post" class="custom-centered" style="margin-top:20px;">
                <div class="row g-3">
                        <div  class="col-5">
                            <label for="txtid" id="LBLid"  name="LBLid">Num Infirmier</label>
                            <input type="text" id="txtid" name="txtid"placeholder="saisir votre id" class="form-control">
     
                            <label for="txtnom" id="LBLNOM"  name="LBLNOM">Nom Infirmier </label>
                            <input type="text" id="txtnom" name="txtnom" placeholder="saisir votre nom" class="form-control">
      
                            <label for="TXTprenom" id="LBLprenom"  name="LBLprenom" > Prenom Infirmier</label>
                            <input type="text" id="TXTprenom" name="TXTprenom" placeholder="saisir prenom" class="form-control" >
                        
                            <label for="tele">  Telephone De L'infirmier</label>
                        ...
                        <div class="col-5">
                            ...
                            <label for="email" id="email" name="email"> Email De L'infirmier</label>
                    ...
                    <input type="text" class="form-control" name="txtrole" placeholder="saisir le role" value="infirmier"  readonly>
                        </div>
                        <div class="col-1"></div>    
                    </div> 
                    <br>
                    <button type="submit" id="bntajouter" name="ajouterinfirmier" class="btn"> <i class="material-icons">add</i></button> 
                </form>
            </div> 
        </div> 
    </div> 
