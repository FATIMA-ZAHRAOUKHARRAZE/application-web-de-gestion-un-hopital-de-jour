...
if( !empty($_POST))
    {
        if(isset($_POST['ajoutermedecinpharmacie']))
        {
                $id=$_POST['txtid'];
                $nom=$_POST['txtnom'];
        ...
        $m->insertuser($values);
        $m=new UserModel();
        $m->InsertMedecinPharmacie($value);
...
<head>
    ...
    <title>Ajouter Medecin Pharmacie</title>
    <style type="text/css">
        .btn{
        ...
        <div class="container"  style="margin-bottom:70px;">  
            <div class="col-sm-12" >
                <form method="post" name="FRMDIPLOME"  style="margin-top:20px; margin-left:100px;">
                    <div class="row g-3">
                        <div  class="col-5">
                            <label for="txtid" id="LBLid"  name="LBLid">Num Medecin Pharmacie</label>
                            <input type="text" id="txtid" name="txtid"placeholder="saisir votre id" class="form-control">
     
                            <label for="txtnom" id="LBLNOM"  name="LBLNOM">Nom Medecin Pharmacie</label>
                            <input type="text" id="txtnom" name="txtnom" placeholder="saisir votre nom" class="form-control">
      
                            <label for="TXTprenom" id="LBLprenom"  name="LBLprenom" > Prenom Medecin Pharmacie</label>
                            <input type="text" id="TXTprenom" name="TXTprenom" placeholder="saisir prenom" class="form-control" >
                        
                            <label for="tele">  Telephone De Medecin Pharmacie</label>
                        ...
                        <div class="col-5">
                            ...
                            <label for="email" id="email" name="email"> Email De Medecin Pharmacie</label>
                    ...
                    <input type="text" class="form-control" name="txtrole" placeholder="saisir le role" value="mpharmacie"  readonly>
                        </div>
                        <div class="col-1"></div>    
                    </div> 
                    <br>
                    <button type="submit" id="bntajouter" name="ajoutermedecinpharmacie" class="btn"> <i class="material-icons">add</i></button> 
                </form>
            </div> 
        </div> 
    </div> 
